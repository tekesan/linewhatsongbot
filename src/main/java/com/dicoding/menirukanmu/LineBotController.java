        ...
        @RequestBody String aPayload)
    {
        ...
        if (eventType.equals("join")){
            ...
            if (!payload.events[0].message.type.equals("text")){
                ...
                if (payload.events[0].message.text.contains("help" || "Help")){
                    msgText = "Aku bisa menebak judul lagu apa yang kamu kirim, dengan cara ketik potongan lirik 
                    (ex : kamu dimana dengan siapa, so baby pull me closer, nenek sudah tua giginya tinggal dua) Let's guess the song together with meh!!";
                }
